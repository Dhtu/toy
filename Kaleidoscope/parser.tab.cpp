...
static const char *const yytname[] =
{
  ...
  "TMUL", "TDIV", "TIF", "TTHEN", "TELSE", "TFOR", "TIN", "TRETURN",
  "TEXTERN", "$accept", "expr", YY_NULLPTR
};
#endif
...
#line 53 "parser.y" /* yacc.c:1646  */
    {
        ...
        std::cout<<"Parse (double) "<<(dynamic_cast<NumberExprAST *>(Result))->Val<<std::endl;
        (yyval.expr) = Result;
    }
